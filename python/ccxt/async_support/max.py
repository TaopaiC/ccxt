...
class max(Exchange):
    ...
    async def fetch_markets(self, params={}):
        ...
        for i in range(0, len(markets)):
            ...
            entry = {
                ...
                'limits': {
                    'amount': {
                        'min': self.safe_float(self.options['minimumAmountOfCurrencies'], base),
                        'max': None,
                    },
                    'price': {
                    ...
                    'cost': {
                        'min': self.safe_float(self.options['minimumAmountOfCurrencies'], quote),
                        'max': None,
                    },
                },
            }
    ...
    def calculate_fee(self, symbol, type, side, amount, price, takerOrMaker='taker', params={}):
        ...
        cost = float(self.decimal_to_precision(cost, ROUND, precision, self.precisionMode))
        return {
            'type': takerOrMaker,
            'currency': market[key],
            'rate': rate,
