...
class max(Exchange):
    ...
    def fetch_funding_fees(self, params={}):
        response = self.publicGetWithdrawalConstraint(params)
        #
        #     [
        #       {
        #          "currency": "eth",
    ...
    def fetch_currencies(self, params={}):
        ...
        withdrawalConstraintResponse = self.publicGetWithdrawalConstraint()
    ...
    def fetch_trading_fees(self, params={}):
        ...
        #    }
        self.load_markets()
        response = self.privateGetMembersVipLevel(params)
    ...
    def fetch_order_trades(self, id, symbol=None, since=None, limit=None, params={}):
        ...
        response = self.privateGetTradesMyOfOrder(self.extend(request, params))
