...
class max extends Exchange {
    ...
    public function describe() {
        return $this->deep_extend(parent::describe (), array(
            ...
            'options' => array(
                ...
                'minimumAmountOfCurrencies' => array(
                    'BTC' => 0.001,
                    'BCNT' => 300.0,
                    'BCH' => 0.03,
                    'ETH' => 0.05,
    ...
    public function fetch_markets($params = array ()) {
        ...
        for ($i = 0; $i < count($markets); $i++) {
            ...
            $entry = array(
                ...
                'limits' => array(
                    'amount' => array(
                        'min' => $this->safe_float($this->options['minimumAmountOfCurrencies'], $base),
                        'max' => null,
                    ),
                    'price' => array(
                    ...
                    'cost' => array(
                        'min' => $this->safe_float($this->options['minimumAmountOfCurrencies'], $quote),
                        'max' => null,
                    ),
                ),
            );
    ...
    public function calculate_fee($symbol, $type, $side, $amount, $price, $takerOrMaker = 'taker', $params = array ()) {
        ...
        $cost = floatval ($this->decimal_to_precision($cost, ROUND, $precision, $this->precisionMode));
        return array(
            'type' => $takerOrMaker,
            'currency' => $market[$key],
            'rate' => $rate,
